 ...
 * 
 * @author weichengz
 * @date 2020年5月6日 上午10:04:09
 */
public class HttpzbBean implements Serializable{
	...
	public HttpzbBean(String qqcs, String cgcs, String cgl, String zdsy, String zxsy, String pjsy) {
		super();
		this.qqcs = qqcs;
		this.cgcs = cgcs;
		this.cgl = cgl;
