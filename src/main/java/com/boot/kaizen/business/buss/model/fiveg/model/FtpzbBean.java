 ...
 * 
 * @author weichengz
 * @date 2020年5月6日 上午10:03:52
 */
public class FtpzbBean implements Serializable{
    ...
    private String dlAvg;//下载平均速率（Mbps）
    private String ulAvg;//上传平均速率（Mbps）
    ...
    private String grantDL;//Grant DL Num Avg
    private String grantUL;//Grant UL Num Avg
    ...
    public void setUl256QAM(String ul256QAM) {
        this.ul256QAM = ul256QAM;
    }

    public String getGrantDL() {
        return grantDL;
    }

    public void setGrantDL(String grantDL) {
        this.grantDL = grantDL;
    }

    public String getGrantUL() {
        return grantUL;
    }

    public void setGrantUL(String grantUL) {
        this.grantUL = grantUL;
    }
	...
	public FtpzbBean(String qqcs, String cgcs, String dxcs, String dxl, String xzcl, String sczl, String dlAvg,
			String ulAvg, String dlMax, String ulMax, String dlLowRatio, String ulLowRatio, String macDL, String macUL,
			String mcsDL, String mcsUL, String dl64qam, String dl256qam, String ul64qam, String ul256qam,
			String grantDL, String grantUL, String pdschRBnum, String puschRBnum, String cqi, String rankDL) {
		super();
		this.qqcs = qqcs;
		this.cgcs = cgcs;
		this.dxcs = dxcs;
