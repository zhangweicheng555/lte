 ...
 * 
 * @author weichengz
 * @date 2020年5月6日 上午10:06:37
 */
public class LtewxzbBean implements Serializable{
	...
	public LtewxzbBean(String rsrqd, String rsrqx, String rsrqp, String rsrpd, String rsrpx, String rsrpp, String sinrd,
			String sinrx, String sinrp, String cssc, String fgl, String fglc, String zlc, String lcfgl, String rsrqd_y,
			String rsrqx_y, String rsrqp_y, String rsrpd_y, String rsrpx_y, String rsrpp_y, String sinrd_y,
			String sinrx_y, String sinrp_y, String cssc_y, String fgl_y, String fglc_y, String zlc_y, String lcfgl_y,
			String comptestRsrp0, String comptestRsrp1, String comptestRsrp2) {
		super();
		this.rsrqd = rsrqd;
		this.rsrqx = rsrqx;
		this.rsrqp = rsrqp;
