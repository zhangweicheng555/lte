	...
	public JsonMsgUtil create5gIndex() throws IOException {
		...
		XContentBuilder mappingLogMain = XContentFactory.jsonBuilder()//
				...
				.startObject("properties")//
					...
					.startObject("mLongitude").field("type", "float").endObject()
					.startObject("mLatitude").field("type", "float").endObject()
				.endObject()//
				.endObject()//
				//这个是复杂属性结束
...
*/				.endObject()//
	...
	public Map<String, Object> settings(@RequestParam(value="index",required=false) String indexVal) throws IOException {
